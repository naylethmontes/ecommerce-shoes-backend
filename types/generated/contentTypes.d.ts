...
export interface ApiColorColor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    imageColor: Attribute.Media<'images' | 'files' | 'videos' | 'audios', true>;
    name: Attribute.String;
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    signature: Attribute.String & Attribute.Required;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    style: Attribute.Enumeration<['Casual', 'Deportivo', 'Elegante']>;
    taste: Attribute.Enumeration<['liviano', 'altos', 'fresco']>;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::product.product',
      'oneToOne',
